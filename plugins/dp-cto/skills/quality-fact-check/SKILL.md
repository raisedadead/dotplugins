...
If no research tool calls are present in this conversation, inform the user: "No research-derived claims found in this conversation. Use WebSearch, WebFetch, or MCP tools first, then re-run /dp-cto:quality-fact-check." and STOP.
